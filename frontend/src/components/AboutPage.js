    ...
    <div className="pt-[100px] px-8 py-12 text-center bg-gray-50">
      <header className="mb-8 max-w-3xl mx-auto text-left">
        ...
        <p className="text-lg text-gray-600 mb-8">
          ...
          >{" "}
            this chapter
          </a> by Brian Moseley and Megan Lavengood to become more familiar with its concepts.
        </p>
