  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center">
      <div className="bg-white p-5 max-w-sm w-11/12 rounded-lg shadow-lg text-left">
        <h2 className="text-xl font-bold mb-3">About the Lattice Visualizer</h2>
        <p className="mb-2">
          This 3D lattice visualizer arranges ratios as spheres on a lattice based on their prime factorizations.
        </p>
        <p className="mb-2">
        ...
        <p className="mb-2">
          I am experimenting with placing prime ratios above 7, since it introduces a fourth spatial dimension, which is always challenging to visualize on a 2D surface. But here, in 3D space, I'm using higher primes and the golden ratio to distribute ratios on an imaginary sphere around the central 1/1 ratio ensuring that prime ratios are uniquely placed, but not on the cubic lattice.
        </p>
        <p className="mb-2">
